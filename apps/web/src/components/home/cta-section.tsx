export function CtaSection() {
  return (
    ...
    >
      ...
      <div className="relative mx-auto max-w-[var(--landing-container-max)] text-center">
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          <a
            href="/register"
            className="inline-flex items-center gap-2 rounded-lg bg-white px-8 py-4 text-lg font-semibold text-[hsl(var(--landing-accent-primary))] shadow-lg transition-all duration-[var(--landing-transition-normal)] hover:-translate-y-1 hover:shadow-xl focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-4 focus-visible:ring-offset-[hsl(var(--landing-accent-primary))]"
          >
