      ...
      <div className="rounded-3xl bg-[hsl(var(--landing-bg-card))] p-6 shadow-2xl">
        ...
        <div className="relative mb-6 overflow-hidden rounded-2xl bg-[hsl(var(--landing-bg-dark))] p-8">
          ...
          <div className="relative mx-auto h-32 w-32">
            <svg
              viewBox="0 0 64 64"
              className="h-full w-full text-[hsl(var(--landing-text-muted)/0.3)]"
              fill="currentColor"
            >
              ...
              <rect
                ...
                width="12"
                height="12"
                className="text-[hsl(var(--landing-bg-dark))]"
              />
              <rect
                x="44"
                y="8"
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between text-sm">
            ...
            <span className="font-semibold text-[hsl(var(--landing-accent-secondary))]">
              847 today
            </span>
          </div>
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-3 rounded-lg bg-[hsl(var(--landing-bg-dark))] p-3">
              ...
              <div className="flex-1">
                <div className="text-sm font-medium text-[hsl(var(--landing-text-primary))]">
                  VIP Fast Pass
                </div>
