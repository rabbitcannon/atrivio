...
function StationsPageContentInner({ orgId }: StationsContentProps) {
...
export function StationsContent({ orgId }: StationsContentProps) {
  return (
    <Suspense fallback={<StationsPageLoadingSkeleton />}>
      <StationsPageContentInner orgId={orgId} />
    </Suspense>
  );
}
