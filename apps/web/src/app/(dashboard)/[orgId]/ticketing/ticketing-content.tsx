...
import { apiClientDirect as apiClient, getAnalyticsDashboard } from '@/lib/api/client';
...
export function TicketingContent({ orgId, orgIdentifier }: TicketingContentProps) {
  const shouldReduceMotion = useReducedMotion();
