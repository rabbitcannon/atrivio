...
export class TemplatesController {
  ...
  async listTemplates(@Tenant() ctx: TenantContext, @Param('attractionId') attractionId: string) {
  ...
  async getTemplate(@Tenant() ctx: TenantContext, @Param('templateId') templateId: string) {
  ...
  async deleteTemplate(@Tenant() ctx: TenantContext, @Param('templateId') templateId: string) {
